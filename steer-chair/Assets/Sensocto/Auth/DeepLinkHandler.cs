...
namespace Sensocto.Auth
{
    ...
    /// - scene: Scene to load after auth (optional, default: DriveChair)
    /// </summary>
    public class DeepLinkHandler : MonoBehaviour
    {
        ...
        [Header("Settings")]
        [SerializeField] private string defaultScene = "DriveChair";
        ...
        private void TestDeepLinkInEditor()
        {
            ...
            {
                testDeepLink = "sensocto://auth?token=test-token-123&user=TestUser&scene=DriveChair";
            }
